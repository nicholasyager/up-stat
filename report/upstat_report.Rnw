...
traffic congestion based on the time of day and day of the week.
...
legend("topleft", fill=c("black","blue","orange"),
       legend=c("Oct. 16, 2013","Dec. 18, 2013","Thanksgiving"))
